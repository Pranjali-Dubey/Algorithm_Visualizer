...
const NotesPage = () => {
  ...
  const handleSubscribeClick = () => {
    navigate('/Payments'); // Redirects directly to the payment page
  };
  ...
  return (
    <div className="notes-page">
      {!isPremium && (
        <div className="overlay">
          <div className="subscription-card">
            ...
            <p>Subscribe to gain access to all notes, problem sets, and exclusive features:</p>
            <ul className="premium-features">
              <li>Full access to in-depth notes and problem sets</li>
              <li>Downloadable PDFs for offline study</li>
              <li>Exclusive algorithm tutorials and examples</li>
              <li>Priority support for questions and feedback</li>
            </ul>
      ...
      <div className={`main-container ${!isPremium ? 'blurred' : ''}`}>
